...
public interface BeanPopulatorSpi extends BeanPopulatorBaseSpi {
    /**
     * Bean Populator Factory SPI, which is used to create a bean populator which can then be used to determine whether
     * a specific JavaBean property should be propagated from a source bean to a target bean.
     * 
     * @author Joe D. Velopar
     */
    ...
    /**
     * Used to configure a transformer to transform a property value read from a source JavaBean into a value to be to
     * set the corresponding property of a target JavaBean.
     * 
     * @param transformer is used to transform every property value read from a source JavaBean into a value to be to
     *            set the corresponding property of a target JavaBean.
