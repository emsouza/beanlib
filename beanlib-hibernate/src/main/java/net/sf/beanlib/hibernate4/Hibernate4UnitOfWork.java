...
/**
 * Hibernate 4 Unit Of Work. A Hibernate Unit-Of-Work means a unit of work that executes within a single atomic
 * Hibernate transaction that either commits or roll backs upon returning from the execution.
 * 
 * @author Joe D. Velopar
 */
public abstract class Hibernate4UnitOfWork {
    private static final Logger logger = Logger.getLogger(Hibernate4UnitOfWork.class);

    protected final Session session;

    public Hibernate4UnitOfWork(Session sess) {
        this.session = sess;
    }
