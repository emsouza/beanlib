...
public interface BeanPopulationExceptionHandler {
    ...
    final BeanPopulationExceptionHandler ABORT = new BeanPopulationExceptionHandlerAdapter();

    /** Exception handler which always continue by logging and then igoring the exception or error. */
    final BeanPopulationExceptionHandler CONTINUE = new BeanPopulationExceptionHandlerAdapter() {
        @Override
    ...
    void handleException(Throwable t, Logger log);
