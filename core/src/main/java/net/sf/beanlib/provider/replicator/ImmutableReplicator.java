...
public class ImmutableReplicator implements ImmutableReplicatorSpi {
    ...
    public <V, T> T replicateImmutable(V immutableFrom, Class<T> toClass) {
        ...
        return toClass.isAssignableFrom(immutableFrom.getClass()) ? toClass.cast(immutableFrom) : null;
    }
    ...
    private static boolean sameType(Class<?> lhs, Class<?> rhs) {
        return lhs == boolean.class && rhs == Boolean.class || lhs == byte.class && rhs == Byte.class || lhs == char.class && rhs == Character.class
                || lhs == short.class && rhs == Short.class || lhs == int.class && rhs == Integer.class || lhs == long.class && rhs == Long.class
                || lhs == float.class && rhs == Float.class || lhs == double.class && rhs == Double.class;
    }
}
