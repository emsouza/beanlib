...
public class BeanReplicatorTest {
    ...
    public static class ComplexBean {
        ...
        public Collection<ComplexBean> getCollection() {
            return collection;
        }

        public void setCollection(Collection<ComplexBean> collection) {
            this.collection = collection;
        }

        public ComplexBean[] getArray() {
            return array;
        }

        public void setArray(ComplexBean[] array) {
            this.array = array;
        }

        public Map<String, ComplexBean> getMap() {
            return map;
        }

        public void setMap(Map<String, ComplexBean> map) {
            this.map = map;
        }
